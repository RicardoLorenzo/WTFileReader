...
#define WT_CELL_HEADER_SIZE (1 + 1 + WT_INTPACK64_MAXSIZE + WT_INTPACK32_MAXSIZE)

typedef struct wt_cell_header { uint8_t __chunk[WT_CELL_HEADER_SIZE]; } wt_cell_header_t;
